                ...
                <form method="post" action="change_password" id="admin-form">
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="old" class="field-label text-muted fs15 mb10">原始密码</label>
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="new1" class="field-label text-muted fs15 mb10">新密码</label>
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="new2" class="field-label text-muted fs15 mb10">重复新密码</label>
