...
//            {
//                List<String> titles = new ArrayList<>(Arrays.asList("cnn"));
//                List<String> authors = new ArrayList<>(Arrays.asList("zhen", "yang"));
...
//            }
            ...
            //搜索论文
            {
                List<String> keywords = new ArrayList<>(Arrays.asList("prospective"));
                SqlDealer.Order order = SqlDealer.Order.REFERENCE_COUNT;
                int limitStart = 20;
                int limitEnd = 40;
